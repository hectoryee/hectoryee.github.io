...
[Welcome to Jekyll post]({{ '/_posts/2019-02-10-create-bash-script.md' | relative_url }})
[Welcome to Jekyll post]({{ site.baseurl }}{% link _posts/2019-02-10-create-bash-script.md %})
